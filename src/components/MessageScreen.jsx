...
export default function MessageScreen({ onNext, ...motionProps }) {
    ...
    const message =
        "Hello Anjali 💔, Aapko pta hai ki mujhe kuchh bhi nhi chahiye Shivay aapke, aur Aapko bar bar preshan kiya uske liye extremely so sorry kyuki me khud se jyada aapka dhyan aur care krna chahta tha kyuki Aapko khush dekh kr hi mujhe Khush milti hai"
