...
export default function FinalScreen({ ...motionProps }) {
    ...
    const finalMessage =
        "Every late night I think about you. Every second without you feels incomplete. I miss your smile, your laugh, your voice and everything. You are my peace in this noisy world. No matter the distance, you'll always live in my heart. I am always with you 😔"
    ...
    return (
        <motion.div {...motionProps} className="min-h-screen flex items-center justify-center text-center px-6 relative">
            ...
            <div className="max-w-4xl z-10">
                ...
                >
                    <div><img src="/gifs/sorry.gif" alt="Sorry Anjali" className="w-48" /></div>
                </motion.div>
